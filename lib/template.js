...
module.exports = {
  ...
  topbar: function (request, response) {
    ...
    if (auth.isOwner(request, response)) {
      authStatusUI = `<div id="logout" style="text-align:right;"><a href="/mypage" style="padding:5px;">mypage</a><a href="/logout_process" style="padding:5px;">logout</a></div>`;
    }
    return authStatusUI;
  },
  // 문제 목록
