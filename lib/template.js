...
module.exports={
  HTML:function(style, control, body){
    ...
    var list='<ul style="padding-left : 0;">';
    var i=0;
    while(i < filelist.length){
      list = list + `<li style="padding : 3px; border-top : 1px solid; border-bottom : 1px solid;"><a href="/board/${filelist[i]}">Problem Title : ${filelist[i]}</a></li>`
