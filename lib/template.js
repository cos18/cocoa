...
module.exports = {
  ...
  // 그룹페이지
  group: function (menustr, content, topbar) {
    const menu = [{
        name: "전체 그룹",
        link: "/group"
      },
  ...
  result_page: function (result, topbar) {
    let resultCode = [{
      ...
      },
      {
        ...
        content: "코드의 문법적인 에러를 찾아보세요!"
      },
      {
        title: "오답!",
        icon: "times circle outline",
        content: "의도한 답과는 다른 결과나 나왔습니다."
      },
      {
        title: "시간 초과",
        icon: "clock outline",
        content: "더 쉬운 길을 두고 돌아가는건 아닐까요? 쉬운 길을 찾아보세요!"
      },
      {
        title: "출력 초과",
        icon: "exclamation circle",
        content: "주로 무한루프가 걸렸을 때 일어납니다. 무한루프를 찾아보세요!"
      },
    ]
